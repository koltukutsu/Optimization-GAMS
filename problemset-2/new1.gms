...
k vehicles            /vehicle1, vehicle2, vehicle3, vehicle4, vehicle5, vehicle6, vehicle7/;
...
scalar fp 'fuel price' /4.5/;

set i0(i) 'depot' /ziraat/;

set i1(j) 'depot again yet there is no need to be defined again I guess so' /ziraat/;
