...
positive variables
    ...
    y(i,k) 'split capacity coming from different vehicles for the demand'
;
...
equations
    ...
    split_supply_constraint(i)
    split_supply_and_position_constraint(i, k)
    ...
    demand_and_capacity_constraint(k).. sum(i$(ord(i)ge 3), q(i) * y(i, k)) =l= cap(k);
    ...
    split_supply_constraint(i)$(ord(i)ge 3).. sum(k, y(i,k)) =e= 1;
    split_supply_and_position_constraint(i, k)$(ord(i)ge 3).. y(i,k) =l= sum(j, x(j,i,k));
